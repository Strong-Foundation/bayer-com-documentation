...
def wait_for_pdf_download(
    download_folder: str, files_before_download: set[str], timeout_seconds: int = 180
) -> str:
...
def main() -> None:
    html_file_path: str = "bayer.com.html"  # Name of HTML file
    ...
    if not check_file_exists(
        ...
        url: str = (
            f"https://www.bayer.com/en/agriculture/safety-results-crop-protection-products"
        )
